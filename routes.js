...
window.FEHO_ROUTES = [
  ...
  },
  {
    ...
    name: "ROTA-3 - Kaynak Link Rotası",
    description: "Kısa link kaynak olarak kayıtlı; bu rota haritada durak eklenerek düzenlenebilir.",
  ...
  },
  {
    ...
    name: "ROTA-4 - Kaynak Link Rotası",
    description: "Kısa link kaynak olarak kayıtlı; bu rota uygulama içinde düzenlenebilir.",
    startPoint: CAYYOLU_START_POINT,
    endPoint: "Planlanacak",
    distanceKm: null,
    estimatedDuration: "Planlanacak",
  ...
  },
  {
    ...
    name: "ROTA-5 - Kaynak Link Rotası",
    description: "Kısa link kaynak olarak kayıtlı; bu rota uygulama içinde düzenlenebilir.",
    startPoint: CAYYOLU_START_POINT,
    endPoint: "Planlanacak",
    distanceKm: null,
  ...
  },
  {
    ...
    name: "ROTA-6 - Kaynak Link Rotası",
    description: "Kısa link kaynak olarak kayıtlı; bu rota uygulama içinde düzenlenebilir.",
    startPoint: CAYYOLU_START_POINT,
    endPoint: "Planlanacak",
    distanceKm: null,
  ...
  {
    id: "shortlink-r6hys8",
    name: "ROTA-7 - Kaynak Link Rotası",
    description: "Kısa link kaynak olarak kayıtlı; bu rota uygulama içinde düzenlenebilir.",
    startPoint: CAYYOLU_START_POINT,
    endPoint: "Planlanacak",
    distanceKm: null,
  ...
  {
    id: "shortlink-hldd8",
    name: "ROTA-8 - Kaynak Link Rotası",
    description: "Kısa link kaynak olarak kayıtlı; bu rota uygulama içinde düzenlenebilir.",
    startPoint: CAYYOLU_START_POINT,
    endPoint: "Planlanacak",
    distanceKm: null,
  ...
  {
    id: "shortlink-b3f4v",
    name: "ROTA-9 - Kaynak Link Rotası",
    description: "Kısa link kaynak olarak kayıtlı; bu rota uygulama içinde düzenlenebilir.",
    startPoint: CAYYOLU_START_POINT,
    endPoint: "Planlanacak",
    distanceKm: null,
